...
patron <- c(`[` = "", `]` = "", `"` = "", `'` = "") |> coll()
datos |> separate_longer_delim(boardgamecategory, delim = ", ") |>
  mutate(boardgamecategory_limpio = str_replace_all(boardgamecategory, pattern = patron))
...
sub_datos |> rowwise() |>
  ...
  unnest_longer(transporte)

# Contar número de transportes por personaje
starwars |> rowwise() |> mutate(num_transportes = length(c(vehicles, starships)))
